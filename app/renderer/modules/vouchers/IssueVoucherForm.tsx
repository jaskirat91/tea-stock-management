      ...
      <div className="flex-1 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6 bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-2xl shadow-sm">
          <div className="grid grid-cols-2 gap-4">
             <SearchableSelect id="firm_id" options={masters.firms} value={formData.firm_id} onChange={id => setFormData(p=>({...p, firm_id: id}))} onSelect={() => moveFocus('firm_id', 'next')} placeholder="Select Firm" masterRoute="Firm Master" label="Firm" />
